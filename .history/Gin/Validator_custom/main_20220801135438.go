...
func main() {
	...
	if v, ok := binding.Validator.Engine().(*validator.Validate); ok {
		...
		v.RegisterValidation("bookabledate",checkName)
	}
...
func , topStruct reflect.Value, currentStructOrField reflect.Value,
field reflect.Value, fieldType reflect.Type, fieldKind reflect.Kind, param string,(v *validator.Validate, topStruct reflect.Value, currentStructOrField reflect.Value,
