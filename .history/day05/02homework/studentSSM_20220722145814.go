...
func (sm studentSSM) insertStudent() {
	fmt.Println("please enter new student message")

	// var (
	// 	id   int
	// 	name string
	// )
	// fmt.Println("please enter new student id")
	// fmt.Scanln(&id)
	// fmt.Println("please enter new student name")
	// fmt.Scanln(&name)
	// stu := student{
	// 	id:   id,
	// 	name: name,
...
func (sm studentSSM) updateStudent() {
	var id int
	fmt.Println("please enter update student id")
	fmt.Scanln(&id)
...
func (sm studentSSM) deleteStudent() {
	var id int
	fmt.Println("please enter delete student id")
	fmt.Scanln(&id)
	stu, ok := sm.allstudent[id]
	if ok {
